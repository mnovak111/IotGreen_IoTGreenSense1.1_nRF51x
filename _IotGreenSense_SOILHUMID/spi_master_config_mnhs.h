...
/*  SPI0 */
#define SPI_PSELSCK0              13   /*!< GPIO pin number for SPI clock (note that setting this to 31 will only work for loopback purposes as it not connected to a pin) */
#define SPI_PSELMOSI0             14   /*!< GPIO pin number for Master Out Slave In    */
#define SPI_PSELMISO0             12   /*!< GPIO pin number for Master In Slave Out    */
#define SPI_PSELSS0               10   /*!< GPIO pin number for Slave Select           */

/*  SPI1 */
#define SPI_PSELSCK1              13   /*!< GPIO pin number for SPI clock              */
#define SPI_PSELMOSI1             14   /*!< GPIO pin number for Master Out Slave In    */
#define SPI_PSELMISO1             12   /*!< GPIO pin number for Master In Slave Out    */
#define SPI_PSELSS1               31   /*!< GPIO pin number for Slave Select           */

//#define DEBUG
#ifdef  DEBUG
#define DEBUG_EVENT_READY_PIN0    31    /*!< when DEBUG is enabled, this GPIO pin is toggled everytime READY_EVENT is set for SPI0, no toggling means something has gone wrong */
#define DEBUG_EVENT_READY_PIN1    31    /*!< when DEBUG is enabled, this GPIO pin is toggled everytime READY_EVENT is set for SPI1, no toggling means something has gone wrong */
#endif
